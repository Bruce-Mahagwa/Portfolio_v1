                            ...
                            <Timeline.Item key={id}>
                                ...
                                >
                                    ...
                                    <Timeline.Content className="px-1" >
                                        <Timeline.Time>{duration}</Timeline.Time>
                                        <Timeline.Title className="text-white opacity-50 text-left">{id}</Timeline.Title>
                                        <Timeline.Body>
                                            {Object.keys(tasks).map((item) => {
                                                return (
                                                    <p key={item}>{tasks[item]}</p>
                                                )
                                            })}
                                        </Timeline.Body>
                                    </Timeline.Content>
